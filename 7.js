...
class EmployeeIterator {
  ...
  #employees; // Приватна властивість для масиву працівників
  #currentIndex; // Приватна властивість для поточної позиції
  ...
  next() {
    if (this.hasNext()) {
      const currentEmployee = this.#employees[this.#currentIndex];
      this.#currentIndex++;
