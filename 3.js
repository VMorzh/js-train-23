...
class GreenTeaMaker extends TeaMaker {
  ...
  addCondiments() {
    console.log("5.Додаємо мед, щоб приготувати зелений чай...");
  }
}
...
class BlackTeaMaker extends TeaMaker {
  ...
  addCondiments() {
    console.log("5.Додаємо мед, щоб приготувати чорний чай...");
  }
}
